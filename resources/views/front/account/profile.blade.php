          ...
          <form action="" method="post" id="userForm" name="userForm">
            <div class="card-body  p-4">
              ...
              <div class="mb-4">
                ...
                <input type="text" name="email" name="email" placeholder="Enter Email" class="form-control"
                  value="{{$user->email}}">
                <p></p>
              </div>
              <div class="mb-4">
        ...
        <div class="card border-0 shadow mb-4">
          <form action="" method="post" id="changePassword" name="changePassword">
            <div class="card-body p-4">
              ...
              <div class="mb-4">
                <label for="" class="mb-2">Xác nhận mật khảu mới*</label>
    ...
    success: function(response) {
      if (response.status == true) {
        ...
        if (errors.old_password) {
          $("#old_password").addClass("is-invalid").siblings('p').addClass('invalid-feedback').html(errors
            .old_password);
        } else {
          $("#old_password").removeClass("is-invalid").siblings('p').removeClass('invalid-feedback').html();
        }
        if (errors.new_password) {
          $("#new_password").addClass("is-invalid").siblings('p').addClass('invalid-feedback').html(errors
            .new_password);
        } else {
          $("#new_password").removeClass("is-invalid").siblings('p').removeClass('invalid-feedback').html();
        }
        if (errors.confirm_password) {
          $("#confirm_password").addClass("is-invalid").siblings('p').addClass('invalid-feedback').html(errors
            .confirm_password);
        } else {
